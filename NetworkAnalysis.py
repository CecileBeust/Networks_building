...
print("PPI")
analyse_network("Multiplex/PPI/network_output/PPI_LitBM_HiUnion_APID.tsv")
print(" ")
print("Pathway")
analyse_network("Multiplex/Pathways/network_output/Pathways_reactome.tsv")
print(" ")
print("Complexes")
analyse_network("Multiplex/Complexes/network_output/Complexes_ntw_gene_names.tsv")
"""print(" ")
print("CoExp")
analyse_network("Multiplex/CoExpression/Coexpression_edges.tsv")
print(" ")
